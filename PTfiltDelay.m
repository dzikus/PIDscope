...
guiHandlesSpec.AphasedelayText1 = uicontrol(PTspecfig,'style','text','string',['Gyro: ' PhaseDelay_A{get(guiHandlesSpec.FileSelect{1}, 'Value')} 'ms, Dterm: ' PhaseDelay2_A{get(guiHandlesSpec.FileSelect{1}, 'Value')} 'ms'],'fontsize',fontsz*.9,'TooltipString', [TooltipString_phase],'units','normalized','BackgroundColor',bgcolor,'Position',[posInfo.AphasedelayText1]);
