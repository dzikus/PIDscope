function idx = PTdebugModeIndices(fwType, fwMajor, fwMinor)
%% PTdebugModeIndices - return debug mode index constants for a given firmware version
%  idx = PTdebugModeIndices(fwType, fwMajor, fwMinor)
