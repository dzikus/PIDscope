...
for i = 1 : 3
    ...
    if guiHandlesSpec3.ColormapSelect.Value<=7,
        colormap(char(guiHandlesSpec3.ColormapSelect.String(guiHandlesSpec3.ColormapSelect.Value)));
    end
    if guiHandlesSpec3.ColormapSelect.Value==8, colormap(linearREDcmap); end
    if guiHandlesSpec3.ColormapSelect.Value==9, colormap(linearGREYcmap); end
