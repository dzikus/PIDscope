...
posInfo.computeSpec=            [cpL+.006 .87 cpW/2-.006 .026];
posInfo.resetSpec=              [cpL+cpW/2 .87 cpW/2-.006 .026];
posInfo.saveFig1=               [cpL+.006 .845 cpW/2-.006 .026];
posInfo.saveSettings1=          [cpL+cpW/2 .845 cpW/2-.006 .026];

posInfo.specPresets=            [cpL+.003 .805 cpW-.006 .035];
posInfo.ColormapSelect=         [cpL+.003 .775 cpW-.006 .035];
posInfo.smooth_select =         [cpL+.003 .745 cpW-.006 .035];
posInfo.controlFreqCutoff_text =[cpL+.003 .725 cpW-.006 .025];
posInfo.controlFreq1Cutoff =    [cpL+.005 .700 cpW/2-.005 .025];
...
if exist('isOctave','var') && isOctave
    ...
    posInfo.computeSpec=            [cpL+.006 .87 cpW/2-.006 .030];
    posInfo.resetSpec=              [cpL+cpW/2 .87 cpW/2-.006 .030];
    posInfo.saveFig1=               [cpL+.006 .838 cpW/2-.006 .030];
    posInfo.saveSettings1=          [cpL+cpW/2 .838 cpW/2-.006 .030];
    posInfo.specPresets=            [cpL+.003 .795 cpW-.006 .035];
    posInfo.ColormapSelect=         [cpL+.003 .758 cpW-.006 .035];
    posInfo.smooth_select=          [cpL+.003 .721 cpW-.006 .035];
    posInfo.controlFreqCutoff_text= [cpL+.003 .700 cpW-.006 .024];
    posInfo.controlFreq1Cutoff=     [cpL+.005 .675 cpW/2-.005 .024];
...
posInfo.AphasedelayText2=[.27 .984 .14 .02];
posInfo.AphasedelayText3=[.48 .984 .14 .02];
posInfo.AphasedelayText4=[.69 .984 .14 .02];

posInfo.hCbar1pos=[0.04 0.89 0.175  0.02];
...
posInfo.hDropdn2pos=[0.29 0.97 0.095   ddh];
posInfo.hDropdn3pos=[0.50 0.97 0.095   ddh];
posInfo.hDropdn4pos=[0.71 0.97 0.095   ddh];

posInfo.fDropdn1pos=[0.08 0.942 0.095  ddh];
posInfo.fDropdn2pos=[0.29 0.942 0.095  ddh];
posInfo.fDropdn3pos=[0.50 0.942 0.095  ddh];
posInfo.fDropdn4pos=[0.71 0.942 0.095  ddh];

posInfo.Sub100HzCheck1=[0.175 0.942 .06 .025];
posInfo.Sub100HzCheck2=[.385 .942 .06 .025];
posInfo.Sub100HzCheck3=[.595 .942 .06 .025];
posInfo.Sub100HzCheck4=[.805 .942 .06 .025];

posInfo.climMax_text = [.01 .913 .025 .024];
posInfo.climMax_input = [.01 .888 .025 .024];
posInfo.climMax_text2 = [.22 .913 .025 .024];
posInfo.climMax_input2 = [.22 .888 .025 .024];
posInfo.climMax_text3 = [.43 .913 .025 .024];
posInfo.climMax_input3 = [.43 .888 .025 .024];
posInfo.climMax_text4 = [.64 .913 .025 .024];
posInfo.climMax_input4 = [.64 .888 .025 .024];
...
guiHandlesSpec.specPresets = uicontrol(PTspecfig,'Style','popupmenu','string',{'Presets:'; '1. Gyro prefilt | Gyro | Dterm prefilt | Dterm' ;  '2. Gyro prefilt | Gyro | Pterm | Dterm' ; '3. Gyro | Dterm | Set point | PID error' ; '4. A|A|B|B Gyro prefilt | Gyro' ; '5. A|A|B|B Dterm prefilt | Dterm' ; '6. A|B|C|D Gyro prefilt ' ;'7. A|B|C|D Gyro '; '8. A|B|C|D Dterm '; '9. A|B|C|D PID error'},...
    ...
    ['pv=get(guiHandlesSpec.specPresets,''Value''); ',...
     'if pv==1, set(guiHandlesSpec.SpecSelect{1},''Value'',1); set(guiHandlesSpec.SpecSelect{2},''Value'',1); set(guiHandlesSpec.SpecSelect{3},''Value'',1); set(guiHandlesSpec.SpecSelect{4},''Value'',1); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==2, set(guiHandlesSpec.SpecSelect{1},''Value'',3); set(guiHandlesSpec.SpecSelect{2},''Value'',2); set(guiHandlesSpec.SpecSelect{3},''Value'',8); set(guiHandlesSpec.SpecSelect{4},''Value'',7); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==3, set(guiHandlesSpec.SpecSelect{1},''Value'',3); set(guiHandlesSpec.SpecSelect{2},''Value'',2); set(guiHandlesSpec.SpecSelect{3},''Value'',6); set(guiHandlesSpec.SpecSelect{4},''Value'',7); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==4, set(guiHandlesSpec.SpecSelect{1},''Value'',2); set(guiHandlesSpec.SpecSelect{2},''Value'',7); set(guiHandlesSpec.SpecSelect{3},''Value'',5); set(guiHandlesSpec.SpecSelect{4},''Value'',4); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',1); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',1); end;',...
     'if pv==5, set(guiHandlesSpec.SpecSelect{1},''Value'',3); set(guiHandlesSpec.SpecSelect{2},''Value'',2); set(guiHandlesSpec.SpecSelect{3},''Value'',3); set(guiHandlesSpec.SpecSelect{4},''Value'',2); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==6, set(guiHandlesSpec.SpecSelect{1},''Value'',8); set(guiHandlesSpec.SpecSelect{2},''Value'',7); set(guiHandlesSpec.SpecSelect{3},''Value'',8); set(guiHandlesSpec.SpecSelect{4},''Value'',7); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==7, set(guiHandlesSpec.SpecSelect{1},''Value'',3); set(guiHandlesSpec.SpecSelect{2},''Value'',3); set(guiHandlesSpec.SpecSelect{3},''Value'',3); set(guiHandlesSpec.SpecSelect{4},''Value'',3); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==8, set(guiHandlesSpec.SpecSelect{1},''Value'',2); set(guiHandlesSpec.SpecSelect{2},''Value'',2); set(guiHandlesSpec.SpecSelect{3},''Value'',2); set(guiHandlesSpec.SpecSelect{4},''Value'',2); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==9, set(guiHandlesSpec.SpecSelect{1},''Value'',7); set(guiHandlesSpec.SpecSelect{2},''Value'',7); set(guiHandlesSpec.SpecSelect{3},''Value'',7); set(guiHandlesSpec.SpecSelect{4},''Value'',7); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;',...
     'if pv==10, set(guiHandlesSpec.SpecSelect{1},''Value'',4); set(guiHandlesSpec.SpecSelect{2},''Value'',4); set(guiHandlesSpec.SpecSelect{3},''Value'',4); set(guiHandlesSpec.SpecSelect{4},''Value'',4); set(guiHandlesSpec.Sub100HzCheck{1},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{2},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{3},''Value'',0); set(guiHandlesSpec.Sub100HzCheck{4},''Value'',0); end;']); 
...
guiHandlesSpec.resetSpec = uicontrol(PTspecfig,'string','Reset','fontsize',fontsz,'TooltipString', ['Reset Spectral Tool'],'units','normalized','Position',[posInfo.resetSpec],...
    'callback',' for k = 1 :12, delete(subplot(''position'',posInfo.SpecPos(k,:))), end; set(guiHandlesSpec.specPresets, ''Value'', 1); PTspecUIcontrol; set(PTspecfig, ''pointer'', ''arrow'');');
...
guiHandlesSpec.checkboxPSD =uicontrol(PTspecfig,'Style','checkbox','String','PSD','fontsize',fontsz,'TooltipString', ['Power Spectral Density'],...
    'units','normalized','BackgroundColor',bgcolor,'Position',[posInfo.checkboxPSD],'callback', 'PTplotSpec;');
...
guiHandlesSpec.saveFig1 = uicontrol(PTspecfig,'string','Save Fig','fontsize',fontsz,'TooltipString',[TooltipString_saveFig],'units','normalized','ForegroundColor',[saveCol],'Position',[posInfo.saveFig1],...
    'callback','set(guiHandlesSpec.saveFig1, ''FontWeight'', ''bold'');PTsaveFig;set(guiHandlesSpec.saveFig1, ''FontWeight'', ''normal'');'); 
...
guiHandlesSpec.saveSettings1 = uicontrol(PTspecfig,'string','Save Settings','fontsize',fontsz, 'TooltipString',['Save current settings to PTB defaults' ], 'units','normalized','Position',[posInfo.saveSettings1],...
    'callback','set(guiHandlesSpec.saveSettings1, ''FontWeight'', ''bold'');PTsaveSettings; set(guiHandlesSpec.saveSettings1, ''FontWeight'', ''normal'');');
...
guiHandlesSpec.climMax_input4 = uicontrol(PTspecfig,'style','edit','string',[num2str(climScale(get(guiHandlesSpec.checkboxPSD, 'Value')+1, 4))],'fontsize',fontsz,'TooltipString',[TooltipString_scale],'units','normalized','Position',[posInfo.climMax_input4],...
 ...
 guiHandlesSpec.ColormapSelect = uicontrol(PTspecfig,'Style','popupmenu','string',{'viridis','jet','hot','cool','gray','bone','copper','linear-RED','linear-GREY'},...
    'fontsize',fontsz,'TooltipString', [TooltipString_cmap], 'units','normalized','Position',[posInfo.ColormapSelect],'callback','@selection2;updateSpec=1; PTplotSpec;');
