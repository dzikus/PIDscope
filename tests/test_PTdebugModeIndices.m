% test_PTdebugModeIndices.m - tests for PTdebugModeIndices

%!test
%! % BF 4.5 (old indices)
%! idx = PTdebugModeIndices('Betaflight', 4, 5);
...
%! idx = PTdebugModeIndices('Betaflight', 2025, 12);
...
%! idx = PTdebugModeIndices('INAV', 7, 1);
%! assert(idx.GYRO_SCALED, 6);
%! assert(idx.RC_INTERPOLATION, 7);
%! assert(idx.FFT_FREQ, 17);
...
%! idx = PTdebugModeIndices('Emuflight', 0, 4);
%! assert(idx.GYRO_SCALED, 6);
%! assert(idx.FFT_FREQ, 17);
