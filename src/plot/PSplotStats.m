%% PSplotStats - script to plot flight statistics
...
if get(guiHandlesStats.crossAxesStats, 'Value')==1    
    if ~isempty(filenameA)
        ...
        RateCurveRoll_A=PSrc2deg([0:5:500],dataA.rates(1,1), dataA.rates(2,1), dataA.rates(3,1), const);
        RateCurvePitch_A=PSrc2deg([0:5:500],dataA.rates(1,2), dataA.rates(2,2), dataA.rates(3,2), const);
        RateCurveYaw_A=PSrc2deg([0:5:500],dataA.rates(1,3), dataA.rates(2,3), dataA.rates(3,3), const);
        ...
        Rpercent_A=PSPercent(DATtmpA.RCcommand(1,:));
        Ppercent_A=PSPercent(DATtmpA.RCcommand(2,:));
        Ypercent_A=PSPercent(DATtmpA.RCcommand(3,:));
    ...
    if ~isempty(filenameB)
        ...
        RateCurveRoll_B=PSrc2deg([0:5:500],dataB.rates(1,1), dataB.rates(2,1), dataB.rates(3,1), const);
        RateCurvePitch_B=PSrc2deg([0:5:500],dataB.rates(1,2), dataB.rates(2,2), dataB.rates(3,2), const);
        RateCurveYaw_B=PSrc2deg([0:5:500],dataB.rates(1,3), dataB.rates(2,3), dataB.rates(3,3), const);
        ...
        Rpercent_B=PSPercent(DATtmpB.RCcommand(1,:));
        Ppercent_B=PSPercent(DATtmpB.RCcommand(2,:));
        Ypercent_B=PSPercent(DATtmpB.RCcommand(3,:));
