...
specH = 0.68 / nValid;  % height per spectrum subplot
specGap = 0.02;
specBot = 0.26;  % bottom of spectrum area (above spectrogram)
...
sgIdx = chIdx(1);
axSg = axes('Parent', fig, 'Units', 'normalized', 'Position', [.07 .13 .86 .11]);
