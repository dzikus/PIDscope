function [fwType, fwMajor, fwMinor] = PSparseBFversion(setupInfo)
%% PSparseBFversion - parse firmware type and version from SetupInfo cell array
%  [fwType, fwMajor, fwMinor] = PSparseBFversion(setupInfo)
